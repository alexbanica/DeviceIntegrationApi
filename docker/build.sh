...
export $(xargs < .env) && \
IMAGE_TAG="${DOCKER_REGISTRY_URI}/device-integration-api:${RELEASE_TAG}-jre${BASE_IMAGE_VERSION}" && \
LATEST_TAG="${DOCKER_REGISTRY_URI}/device-integration-api:latest-jre${BASE_IMAGE_VERSION}"
